...
5. If the app opens in a zip file, extract it first, then open the app inside the folder.
...
3. Check whether Windows blocked the app.
4. Move the file to a simple folder like Downloads or Desktop.
